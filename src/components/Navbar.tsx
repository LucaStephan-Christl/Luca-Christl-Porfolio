...
function Navbar() {
  ...
  return (
    <nav className="">
      ...
      <ul className="hidden md:flex flex-col gap-8 fixed items-center m-5 -translate-y-1/2 top-1/2 py-5 px-3 rounded-full bg-transparent backdrop-blur-lg whitespace-nowrap -motion-translate-x-in-150 motion-duration-[2s] motion-delay-[5s] z-10">
        {Object.entries({
